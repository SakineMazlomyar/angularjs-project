...
//window.getCategories((d)=>{ console.log(d,  'method for window.getCategories hereeeeeeeeeeeee')})
//prodcut
...
//window.getAlotOfCategories((data)=>{ console.log(data, 'window.getAlotOfCategories 1')})
